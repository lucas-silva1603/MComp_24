...
disp(['Pressão máxima: ', num2str(pmax/100000), ' bar em: (', ...
    num2str(xm(p_max_location)), ', ', num2str(ym(p_max_location)), ')']);
disp(['Pressão mínima: ', num2str(pmin/100000), ' bar em: (', ...
...
if exact == 1
    ...
    disp(['Erro absoluto máximo de pressão(bar): ', num2str(errp_max/100000)]);
